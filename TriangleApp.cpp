//***************************************************************************************
// TriangleApp.cpp by Frank Luna (C) 2015 All Rights Reserved.
//
...
void TriangleApp::OnMouseMove(WPARAM btnState, int x, int y)
{
    if ((btnState & MK_LBUTTON) != 0)
    {
        ...
        // Update angles based on input to orbit camera around triangle.
        mTheta += dx;
        mPhi += dy;
...
void TriangleApp::BuildConstantBuffers()
{
    ...
    int triangleCBufIndex = 0;
    cbAddress += triangleCBufIndex * objCBByteSize;
